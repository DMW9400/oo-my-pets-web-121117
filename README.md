...
* An owner should know about its pets! Instances of the `Owner` class should be initialized with a `@pets` variable, set equal to the following hash: `{fishes: [], cats: [], dogs: []}`
